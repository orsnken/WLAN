...
private:
  ...
  uint32_t m_acBECwMin;
  uint32_t m_acBECwMax;  /// AC_BE CwSet - USER DEFINE
  uint32_t m_acBKCwMin;
  uint32_t m_acBKCwMax;  /// AC_BK CwSet - USER DEFINE
  uint32_t m_acVICwMin;
  uint32_t m_acVICwMax;  /// AC_AI CwSet - USER DEFINE
  uint32_t m_acVOCwMin;
  uint32_t m_acVOCwMax;  /// AC_AO CwSet - USER DEFINE
};
